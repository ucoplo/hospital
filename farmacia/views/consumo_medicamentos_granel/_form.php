...
<div class="consumo-medicamentos-granel-form">

    
    <?php $action = $model->isNewRecord ?[ 'id' => 'create-vale-farmacia-form', 'action' => ['consumo_medicamentos_granel/create']]:null;
    ...
    <?= $form->field($model, 'CM_ENFERM')->hiddenInput()->label(false);?>
     <?= $form->field($model, 'vale_granel')->hiddenInput()->label(false);?>
