...
$this->title = 'Monodrogas';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="monodrogas-index">
 <h3><?= Html::encode($this->title) ?></h3>
<div class="monodrogas-search">
...
<?php 
   if (!$filtro){ 
        ...
        $pdfHeader = [
            ...
            'C' => [
                'content' => " <div><img src='images/header_label.png' alt=''></div><div>Monodrogas Vademecum</div>",
                'font-size' => 15,
                'color' => '#333333',
                'height'=> '150px',
                'display' => 'block'
...
<div class="form-group">
        ...
        <?= Html::a('Volver',['monodrogas'],array('class'=>'btn btn-primary'));?>
    </div>
<?php Pjax::begin(); ?>    <?php
...
echo GridView::widget([
        ...
        'pjax'=>true,
        'panel'=>['type'=>'primary', 'heading'=>'Monodrogas'],
        'toolbar'=>[
            '{export}',
            '{toggleData}'
        ],
