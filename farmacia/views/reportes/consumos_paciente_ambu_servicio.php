...
$this->title = 'Consumos Pacientes Ambulatorios y Servicios';
...
<div class="consumos-paciente-servicio-search">
    ...
    <?php $form = ActiveForm::begin([
        'action' => ['consumos_paciente_ambu_servicio'],
        'method' => 'get',
    ]); ?>
   ...
   if (!$filtro){ 
        ...
        $pdfHeader = [
            ...
            'C' => [
                ...
                <div>Consumos Pacientes Ambulatorios y Servicios</div>",
                'font-size' => 15,
                'color' => '#333333',
                'height'=> '150px',
                'display' => 'block'
...
<div class="form-group">
        ...
        <?= Html::a('Volver',['consumos_paciente_ambu_servicio'],array('class'=>'btn btn-primary'));?>
    </div>
<?php Pjax::begin(); ?>    <?php
...
echo GridView::widget([
        ...
        'panel'=>['type'=>'primary', 'heading'=>'Consumos Pacientes Ambulatorios y Servicios'],
        'toolbar'=>[
            '{export}',
            '{toggleData}'
        ],
        ...
        'exportConfig'=>[
             GridView::CSV => [
                'filename' => 'consumos_paciente_ambu_servicio',
            ],
            GridView::PDF => [
