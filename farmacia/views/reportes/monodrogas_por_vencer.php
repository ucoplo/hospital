...
$this->title = 'Monodrogas por Vencer';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="monodrogas-vencer-index">
 <h3><?= Html::encode($this->title) ?></h3>
<div class="monodrogas-vencer-search">

    <?php $form = ActiveForm::begin([
        'action' => ['monodrogas_por_vencer'],
        'method' => 'get',
    ]); ?>
...
<?php 
   if (!$filtro){ 
        ...
        $pdfHeader = [
            ...
            'C' => [
                'content' => " <div><img src='images/header_label.png' alt=''></div><div>Monodrogas por Vencer</div>",
                'font-size' => 15,
                'color' => '#333333',
                'height'=> '150px',
                'display' => 'block'
...
<div class="form-group">
        ...
        <?= Html::a('Volver',['monodrogas_por_vencer'],array('class'=>'btn btn-primary'));?>
    </div>
<?php Pjax::begin(); ?>    <?php
...
echo GridView::widget([
        ...
        'pjax'=>true,
        'panel'=>['type'=>'primary', 'heading'=>'Monodrogas por Vencer'],
        'toolbar'=>[
            '{export}',
            '{toggleData}'
        ],
        ...
        'exportConfig'=>[
             GridView::CSV => [
                'filename' => 'monodrogas_por_vencer',
            ],
            GridView::PDF => [
