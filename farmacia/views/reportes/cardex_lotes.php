...
<div class="form-group">
        ...
        <?= Html::a('Volver',['cardex_lotes'],array('class'=>'btn btn-primary'));?>
    </div>
<?php Pjax::begin(); ?>    <?php
...
echo GridView::widget([
        ...
        'columns' => [
             ...
             [
                ...
                'width'=>'150px',
                'value'=>function ($model, $key, $index, $widget) { 
                    return "Artículo: ".$model->MD_CODMON.' '.$model->monodroga->AG_NOMBRE.'-    Lote:'.Yii::$app->formatter->asDate($model->MD_FECVEN,'php:d-m-Y');
                },
