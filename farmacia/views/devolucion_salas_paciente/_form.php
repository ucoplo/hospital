...
<div class="devolucion-salas-paciente-form">
      <?php $action = $model->isNewRecord ?[ 'id' => 'create-devolucion-farmacia-form', 'action' => ['devolucion_salas_paciente/create']]:null;
    ...
    <div class="row">
        ...
        <div class="col-md-3">
          <?= $form->field($model, 'DE_NUMVALOR')->textInput(['readonly' => 'true']) ?>
        </div>  
    </div>
     <div class="row">
        <div class="col-md-3">
   ...
   <div class="row">
        <div class="col-md-3">
            <?= $form->field($model, 'DE_HISCLI')->textInput(['readonly' => 'true']) ?>
        </div>
        <div class="col-md-9"  id='wrp_paciente'>   
            <?= Html::label('', 'paciente') ?>
            <?php $paciente = ((isset($model->DE_HISCLI))?$model->paciente->PA_APENOM:'');?>
   ...
   <?= $form->field($model, 'DE_UNIDIAG')->hiddenInput()->label(false);?>
     <?= $form->field($model, 'DE_IDINTERNA')->hiddenInput()->label(false);?>
    ...
    <?= $form->field($model, 'renglones')->widget(MultipleInput::className(), [
                ...
                'columns' => [
                     [
                        ...
                        'options' => [
                            'data' => ArrayHelper::map($model->monodrogasVale, 'AG_CODIGO', 
