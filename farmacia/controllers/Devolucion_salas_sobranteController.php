 ...
 */
class Devolucion_salas_sobranteController extends Controller
{
    ...
    private function guardar_renglones($model)
    {
       ...
       foreach ($model->renglones as $key => $obj) {
          ...
          if (count($vencimiento)==1){
              ...
              $vencimiento->TV_CODART = $renglon->DF_CODMON;
              $vencimiento->TV_FECVEN = $renglon->DF_FECVTO;
              $vencimiento->TV_SALDO = $renglon->DF_CANTID;
              $vencimiento->TV_DEPOSITO = $renglon->DF_DEPOSITO;
          }
    ...
    */
    public function actionVencimiento_codmon_remito()
    {
      ...
      $nombre = Yii::$app->params['local_path']['path_farmacia']."/devoluciones_sobrante/".$nombre;
      ...
      $pdf = new Pdf([
          ...
          'options' => ['title' => 'Devolución Sobrante'],
      ]);
