...
$this->title = 'Artículos por Vencer';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="articulos-vencer-index"><?php
    if ($filtro){?>
 <h3><?= Html::encode($this->title) ?></h3>
<div class="articulos-vencer-search">

    <?php $form = ActiveForm::begin([
        'action' => ['articulos_por_vencer'],
        'method' => 'post',
        'layout' => 'horizontal',
        'fieldConfig' => [
...
<?php }
   if (!$filtro){ 
        ...
        $pdfHeader = [
            ...
            'C' => [
                'content' => " <div><img src='images/header_label.png' alt=''></div><div>Artículos por Vencer</div>",
                'font-size' => 15,
                'color' => '#333333',
                'height'=> '150px',
                'display' => 'block'
        ...
        <div class="form-group">
            <?= Html::a('Nueva Búsqueda',['articulos_por_vencer'], ['class' => 'btn btn-success']);?>
