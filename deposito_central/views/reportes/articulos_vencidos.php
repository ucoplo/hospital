...
$this->title = 'Artículos Vencidos';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="articulos-vencidos-index"><?php
    if ($filtro){?>
 <h3><?= Html::encode($this->title) ?></h3>
<div class="articulos-vencidos-search">

    <?php $form = ActiveForm::begin([
        'action' => ['articulos_vencidos'],
        'method' => 'post',
        'layout' => 'horizontal',
        'fieldConfig' => [
...
<?php }
   if (!$filtro){ 
        ...
        $pdfHeader = [
            ...
            'C' => [
                'content' => " <div><img src='images/header_label.png' alt=''></div><div>Artículos Vencidos</div>",
                'font-size' => 15,
                'color' => '#333333',
                'height'=> '150px',
                'display' => 'block'
        ...
        <div class="form-group">
            <?= Html::a('Nueva Búsqueda',['articulos_vencidos'], ['class' => 'btn btn-success']);?>
...
echo GridView::widget([
        ...
        'pjax'=>true,
        'panel'=>['type'=>'primary', 'heading'=>'Artículos Vencidos'],
        'toolbar'=>[
            '{export}',
            '{toggleData}'
        ],
