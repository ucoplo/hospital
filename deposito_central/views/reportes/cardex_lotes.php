...
$this->title = 'Cardex por Lote';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="cardex-lotes-index"><?php
    if ($filtro){?>

 <h3><?= Html::encode($this->title) ?></h3>
<div class="cardex-lotes-search">
...
<?php 
   ...
   if (!$filtro){
        ...
        $pdfHeader = [
            ...
            'C' => [
                'content' => " <div><img src='images/header_label.png' alt=''></div><div>Cardex por Lote</div>",
                'font-size' => 15,
                'color' => '#333333',
                'height'=> '150px',
                'display' => 'block'
        ...
        <div class="form-group">
            <?= Html::a('Nueva Búsqueda',['cardex_lotes'], ['class' => 'btn btn-success']);?>
            ...
            'attributes' => [
                ...
                'fecha_fin',
                 [
                    ...
                    'attribute' => 'deposito',
                    'format' => 'text',
                    'value' => "[$searchModel->articulo]-".$searchModel->articulo_descripcion,
                ],
            ],
        ]);
        ...
        echo GridView::widget([
                ...
                'pjax'=>true,
                'panel'=>['type'=>'primary', 'heading'=>'Cardex por Lote'],
                'toolbar'=>[
                    '{export}',
                    '{toggleData}'
                ],
                ...
                'columns' => [
                     ...
                     [
                        ...
                        'width'=>'150px',
                        'value'=>function ($model, $key, $index, $widget) { 
                            return "Artículo: ".$model->DM_CODART.'-    Lote:'.Yii::$app->formatter->asDate($model->DM_FECVTO,'php:d-m-Y');
                        },
