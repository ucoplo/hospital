...
<div class="devolucion-salas-form">
    ...
    <?php $action = $model->isNewRecord ?[ 'id' => 'create-devolucion-deposito_central-form', 'action' => ['devolucion_salas/create']]:null;
    ...
    <?= $form->field($model, 'renglones')->widget(MultipleInput::className(), [
                ...
                'columns' => [
                     [
                        ...
                        'options' => [
                            'data' => ArrayHelper::map($model->articulosRemito, 'AG_CODIGO', 
