...
CREATE TABLE IF NOT EXISTS `ordenes_compra` (
  ...
  `OC_HORA` time DEFAULT NULL COMMENT 'Hora',
...
CREATE TABLE IF NOT EXISTS `proveedores` (
  ...
  `PR_RAZONSOC` varchar(60) NOT NULL COMMENT 'Razón Social',
  `PR_TITULAR` varchar(60) NOT NULL COMMENT 'Apellido y nombre del titular',
  `PR_CODRAFAM` varchar(5) NOT NULL COMMENT 'Código Proveedor Rafam',
  `PR_CUIT` varchar(13) NOT NULL COMMENT 'CUIT',
  `PR_DOMIC` varchar(40) NOT NULL COMMENT 'Domicilio',
  `PR_TELEF` varchar(30) NOT NULL COMMENT 'Teléfono',
  `PR_EMAIL` varchar(60) NOT NULL COMMENT 'Email',
  `PR_OBS` text NOT NULL COMMENT 'Observaciones',
  `PR_CONTACTO` varchar(45) NOT NULL COMMENT 'Contacto',
  PRIMARY KEY (`PR_CODIGO`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
