 ...
 */
class PedidosReposicionFarmacia extends \yii\db\ActiveRecord
{
    //public $renglones;
    /**
     * @inheritdoc
    ...
    public function rules()
    {
        return [
            [['PE_FECHA'], 'required'],
            [['PE_FECHA', 'PE_HORA', 'renglones'], 'safe'],
    ...
    {
        return $this->hasMany(PedidosReposicionFarmacia_renglones::className(), ['PE_NROPED' => 'PE_NROPED']);
    }
    ...
    {
        return $this->hasMany(Planilla_entrega::className(), ['PE_NUMVALE' => 'PE_NROPED']);
    }
}
